...
const StudyCalendar: React.FC<StudyCalendarProps> = ({ onClose }) => {
  ...
  const getModalInputClasses = () => {
    if (isDarkMode || isDarkGradient) {
      return "w-full px-3 py-2 bg-gray-800 border border-white/20 rounded-lg text-gray-100 focus:outline-none focus:ring-2 focus:ring-violet-500 appearance-none";
    } else {
