...
const Diary: React.FC<DiaryProps> = ({ onClose }) => {
  ...
  const getSelectClasses = () => {
    if (isDarkMode || isDarkGradient) {
      return "w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-violet-500";
    } else {
  ...
  const getOptionClasses = () => isDarkMode || isDarkGradient ? 'text-white' : 'text-gray-900';
